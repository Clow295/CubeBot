...
FILL_LAYER_ADV_BTN_RECT = pygame.Rect(BTN_X, START_BTN_Y + SPACING_BTN * 4, BTN_W, BTN_H)
SHUFFLE_BTN_RECT = pygame.Rect(BTN_X, START_BTN_Y + SPACING_BTN * 5, BTN_W, BTN_H)
CLEAR_LEVEL_BTN_RECT = pygame.Rect(BTN_X, START_BTN_Y + SPACING_BTN * 6, BTN_W, BTN_H)

# --- NÚT MỚI: SYMMETRY ---
SYMMETRY_BTN_RECT = pygame.Rect(BTN_X, START_BTN_Y + SPACING_BTN * 7, BTN_W, BTN_H)

# --- NÚT MỚI: FIX COLOR ---
FIX_COLOR_BTN_RECT = pygame.Rect(BTN_X, START_BTN_Y + SPACING_BTN * 8, BTN_W, BTN_H)

# Controls (Đẩy xuống thấp hơn để không đè lên nút FixColor)
RATIO_LABEL_Y = START_BTN_Y + SPACING_BTN * 9 + 10
