...
#
#     for i in range(len(COLORS)):  # Show full list but dim inactive
...
#     screen.blit(f.render("-", 1, TEXT_WHITE), (RATIO_MINUS_RECT.x + 18, RATIO_MINUS_RECT.y + 8))
#     screen.blit(f.render("+", 1, TEXT_WHITE), (RATIO_PLUS_RECT.x + 18, RATIO_PLUS_RECT.y + 8))
#     screen.blit(pygame.font.SysFont(None, 20).render(f"Shuffle: {state.shuffle_ratio}%", 1, (200, 200, 255)),
#                 (BTN_X + 60, RATIO_LABEL_Y + 30))
#
...
#         screen.blit(pygame.font.SysFont(None, 18).render(t, 1, (200, 200, 200)), (PANEL_RIGHT_X + 20, 720 + k * 18))
#
#
